...
import com.test.adiblaruz.databinding.FragmentMumtozAdabiyotBinding
 ...
 * Use the [MumtozAdabiyotFragment.newInstance] factory method to
...
class MumtozAdabiyotFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment MumtozAdabiyotFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            MumtozAdabiyotFragment().apply {
